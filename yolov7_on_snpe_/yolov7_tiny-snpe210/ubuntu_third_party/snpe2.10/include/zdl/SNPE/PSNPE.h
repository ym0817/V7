...
// NOTE:jcash we don't need _{Create,Delete} functions becauase the user does not create or delete these handles
...
// TODO:jcash move to better location?
typedef struct{
  const uint8_t* data;
  size_t size;
...
//typedef void* Snpe_PSNPE_OutputAsyncCallbackFunc_Handle_t;
//
//// TODO:jcash, I think we don't nee _Create func for this, as
////SNPE_API
////Snpe_PSNPE_OutputAsyncCallbackFunc_Handle_t Snpe_PSNPE_OutputAsyncCallbackFunc_Create(void (*func)(Snpe_PSNPE_OutputAsyncCallbackParam_Handle_t));
//
//SNPE_API
//Snpe_ErrorCode_t Snpe_PSNPE_OutputAsyncCallbackFunc_Delete(Snpe_PSNPE_OutputAsyncCallbackFunc_Handle_t oacfHandle);


// TODO:jcash require ApplicationBufferMap.h
//typedef void* Snpe_PSNPE_InputOutputAsyncCallbackParam_Handle_t;
//
//SNPE_API
//Snpe_PSNPE_InputOutputAsyncCallbackParam_Handle_t Snpe_PSNPE_InputOutputAsyncCallbackParam_Create(size_t index,
//                                                                                                  int status,
//                                                                                                  const char* errorMsg);
//
//SNPE_API
...
// TODO:jcash nomenclature for these two enums? Also, this should be generated from PSNPE.hpp
...
// TODO:jcash why does PSNPE have them named "*ThreadNumbers" not "*ThreadNumber"?
SNPE_API
...
// TODO:jcash rmme, this was used for debugging
SNPE_API
